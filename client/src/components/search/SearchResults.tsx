        ...
        {listings.map((listing) => {
          ...
          return (
            <Link
              ...
              prefetch={true}
            >
              <div className="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-500 hover:translate-y-[-4px] hover:scale-[1.01] group-hover:ring-2 group-hover:ring-[#FF6B35]/20 flex flex-col h-full">
