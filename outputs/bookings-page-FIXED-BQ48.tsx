  ...
  const fetchBookings = async () => {
    try {
      ...
      if (user.role === 'admin') {
        ...
        return; // ✅ Return au lieu de throw pour éviter le crash
      }
      ...
      // ✅ Support multi-formats de réponse
