      ...
      {showAllPhotos && (
        <div className="fixed inset-0 bg-black z-50 overflow-y-auto">
          <div className="min-h-screen p-4">
            <div className="flex justify-between items-center mb-4 sticky top-0 bg-black/80 backdrop-blur-sm p-4 z-10">
              <h2 className="text-white text-2xl font-bold">
                {(t as any)?.imageGallery?.allPhotos || 'All Photos'} ({displayImages.length})
              </h2>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-7xl mx-auto pb-8">
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-2 mb-2">
                    ...
                    <span className="text-gray-600">
                      / {listing.category === 'stay' ? (t as any)?.booking?.perNight || 'night' : (t as any)?.booking?.perDay || 'day'}
                    </span>
                  </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => setGuestDetails(prev => ({ ...prev, children: prev.children + 1 }))}
                              className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-[#FF6B35] transition-colors"
                            >
                              +
                            </button>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => setGuestDetails(prev => ({ ...prev, infants: prev.infants + 1 }))}
                              className="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center hover:border-[#FF6B35] transition-colors"
                            >
                              +
                            </button>
